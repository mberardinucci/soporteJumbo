            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <?php                        
                        ...
                        echo $this->Form->hidden('cau_ticket_id', ['value' => $ticket['cau_ticket_id']]);
                        echo $this->Form->hidden('fizzmod_ticket_id', ['value' => $ticket['fizzmod_ticket_id']]);
                        echo $this->Form->hidden('vtex_ticket_id', ['value' => $ticket['vtex_ticket_id']]);
        ...
        <div class="col-md-6">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <?php
                            echo $this->Form->control('vtex', array('class'=>'form-control', 'label' => 'Ticket Vtex')); ?>
    ...
    <!--/.col (left) -->
        ...
        <div class="col-md-6">
            <div class="box box-primary">
                ...
                <div class="box-body">
                      <?php
                            echo $this->Form->control('fizz', array('class'=>'form-control', 'label' => 'Ticket fizzmod')); ?>
    ...
    <div class="row">    
        <div class="col-md-12">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">Agregar Bitacora</h3>
                </div>
                <div class="box-body">
                <?php 
                $user = $this->request->session()->read('Auth.User');   

                echo $this->Form->control('record_description', array('class'=>'form-control', 'label' => 'Descripción')); 
                echo $this->Form->hidden('record_user_id', ['value' => $user['id']]);                
                ?>
                <div class="form-group">
                     <label>Fecha:</label>
                    ...
                    <div class="input-group date">
                        ...
                        <?php echo $this->Form->control('record_date', array('class' => 'form_datetime form-control pull-right', 'label' => false));  ?>                          
                    </div>
                    <!-- /.input group -->
                </div>  
